...
include('config.php');
$query=mysql_query("SELECT * FROM tbl_tunjangan") or die(mysql_error());
  $per=10;
  $page= isset($_GET['page']) ? (int) $_GET['page'] : 1;
 $start = ($page>1) ? ($page*$per)-$per : 0 ;
  $q=mysql_query("SELECT * FROM tbl_tunjangan ORDER BY id_guru limit $start, $per"); 
...
<div class="main">
  <div class="hipsum">
    <div class="jumbotron">
    <h1>Tunjangan Guru</h1>
      </div>
<div class="in">
<a href="input_tunjangan.php">
<button class="btn btn-success fa fa-pencil">  Input</button>
<a href="laporan_tunjangan.php"><button class="btn btn-default fa fa-download">  Download Laporan Tunjangan</button></a>
<a href="cetak_laporan_tunjangan.php"><button class="btn btn-default fa fa-print">  Cetak Laporan Tunjangan</button></a>
...
$a=1;
  ...
  <tbody>
          <tr>
            ...
            <td><?php echo $data['jml_tunjangan']; ?></td>
            <td><a href="edit_tunjangan.php?id=<?php echo $data['id_guru']; ?>"><button class="btn btn-info fa fa-edit">  Edit</button></a></td>
            <td><a href="delete_tunjangan.php?id=<?php echo $data['id_guru']; ?>" id="idd" data-id="<?php echo $data['id_guru']; ?>"><button class="btn btn-danger fa fa-trash"  name="del"  id="id" data-id="<?php echo $data['id_guru']; ?>">   Delete</button></a></td>
