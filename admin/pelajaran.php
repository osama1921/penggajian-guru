...
$query=mysql_query("SELECT * FROM tbl_jam") or die(mysql_error());
 ...
 $start = ($page>1) ? ($page*$per)-$per : 0 ;
  $q=mysql_query("SELECT * FROM tbl_jam ORDER BY id_guru limit $start, $per"); 
...
<div class="in">
<a href="input_pelajaran.php">
<button class="btn btn-success fa fa-pencil">  Input</button>
<a href="laporan_pelajaraan.php"><button class="btn btn-default fa fa-download">  Download Laporan Mata Pelajaran</button></a>
<a href="cetak_laporan_pelajaraan.php"><button class="btn btn-default fa fa-print">  Cetak Laporan Mata Pelajaran</button></a>
...
$a=1;
  ...
  <tbody>
          <tr>
            ...
            <td><a href="edit_pelajaran.php?id=<?php echo $data['id_guru']; ?>"><button class="btn btn-info fa fa-edit">  Edit</button></a></td>
            <td><a href="delete_pelajaran.php?id=<?php echo $data['id_guru']; ?>" id="idd" data-id="<?php echo $data['id_guru']; ?>"><button class="btn btn-danger fa fa-trash"  name="del"  id="id" data-id="<?php echo $data['id_guru']; ?>">   Delete</button></a></td>
