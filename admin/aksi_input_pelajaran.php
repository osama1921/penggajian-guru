...
if (isset($_POST['input'])) {
	mysql_query("INSERT INTO `tbl_jam`(`id_guru`,`Nama`,`pelajaran`,`jumlah_jam`) VALUES ('$id','$nama','$p','$jam') ") or die(mysql_error());
	echo "
 <script>
  setTimeout(function () {  
   swal({
    title: 'Berhasil',
    text: 'Data Bidang Study ".$nama." Berhasil Ditambahkan',
    type: 'success',
    timer: 5000,
